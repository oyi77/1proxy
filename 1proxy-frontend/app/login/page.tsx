    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100">
      <div className="max-w-md w-full space-y-8 p-8 bg-white rounded-lg shadow-lg">
        <div className="text-center">
          <h2 className="text-3xl font-bold text-gray-900">Login to 1proxy</h2>
          <p className="mt-2 text-sm text-gray-600">Share and discover proxy sources</p>
        </div>
        ...
        {error && (
          <div className="rounded-md bg-red-50 p-4">
            <p className="text-sm text-red-800">
              ...
              {error === 'access_denied' && 'Access denied. Authorization was cancelled.'}
              {!['oauth_failed', 'access_denied'].includes(error) && error}
            </p>
          </div>
        )}
        ...
        <div className="space-y-3">
          ...
          >
            <svg className="w-5 h-5" viewBox="0 0 24 24" suppressHydrationWarning>
              ...
              <path fill="#FBBC05" d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z" suppressHydrationWarning />
              <path fill="#EA4335" d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z" suppressHydrationWarning />
            </svg>
        ...
        <div className="pt-4 border-t">
          <p className="text-center text-sm text-gray-600">
            By logging in, you agree to contribute to the 1proxy community
          </p>
        </div>
