...
**Generated:** 2026-01-13 11:09 AM  
**Commit:** b48634e  
**Branch:** main

## OVERVIEW
Community-driven proxy aggregation platform. FastAPI backend + Next.js 15 frontend. Multi-user OAuth, auto-scraping from GitHub sources, sophisticated validation pipeline (0-100 quality scoring).
...
├── 1proxy-frontend/    # Next.js 15 App Router
│   ├── app/            # File-based routing
│   ├── components/     # Reusable UI (ProxyTable, TabNav)
...
| UI components | `1proxy-frontend/components/` | ProxyTable, TabNavigation |
...
- **Large files** - 3 files >500 lines (likely validators, routers, or UI components)
